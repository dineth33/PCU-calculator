...
def app():
    ...
    speed_data = st.file_uploader(label='Please upload the standard csv file for vehicle speed data')

    # input area values
    st.subheader('Vehicle Area data')
    area_data = st.file_uploader(label='Please upload the standard csv file for vehicle areas')
